...
| **pre_crisis** | 55 | 49.8 | 32.8 | 84.1 |
| **recovery** | 6 | 28.1 | 18.0 | 37.5 |
| **calm** | 42 | 10.7 | 2.2 | 18.4 |
...
|---|---|
| credit stress | 20.1% |
| policy uncertainty | 16.6% |
| geopolitical tail | 10.7% |
...
- **calm** 10.7 → **recovery** 28.1 → **pre_crisis** 49.8 → **active_crisis** 91.1
...
- Pre-crisis 의 top vector: **credit_stress** (20.1%)
